...
return function() {
  ...
  var Q = {
    ...
    createEventSource : function(
        e) { return new EventSource(e, {withCredentials : true}) },
  ...
  var i = w.map(function(e) { return "[hx-" + e + "], [data-hx-" + e + "]" })
              .join(", ");
  var S = e("head"), q = e("title"), H = e("svg", true);
  function e(e, t = false) {
    return new RegExp(`<${e}(\\s[^>]*>|>)([\\s\\S]*?)<\\/${e}>`,
                      t ? "gim" : "im")
  }
  function d(e) {
    if (e == undefined) {
  ...
  function ne(t, r) {
    var n = null;
    c(t, function(e) { return n = L(t, e, r) });
    if (n !== "unset") {
      return n
    }
  }
  ...
  function t(e) {
    return Tr(re().body, function() { return eval(e) })
  }
  function F(t) {
    var e = Q.on("htmx:load", function(e) { t(e.detail.elt) });
    return e
  }
  function V() {
  ...
  function W(e, t) {
    e = g(e);
    oe(e.parentElement.children, function(e) { n(e, t) });
    z(e, t)
  }
  function v(e, t) {
    e = g(e);
  ...
  function s(e, t) { return e.substring(0, t.length) === t }
  ...
  function xe(e, t) {
    return c(e, function(e) { return te(e, t) != null })
  }
  function ye(e) {
  ...
  function Ee(e, i, a) {
    ...
    if (r) {
      oe(r, function(e) {
        ...
        oe(a.elts, function(e) { ce(e, "htmx:oobAfterSwap", n) })
      });
  ...
  function Ne(e) {
    ...
    Ae(e);
    oe(Object.keys(t), function(e) { delete t[e] })
  }
  function p(e) {
    ce(e, "htmx:beforeCleanupElement");
    Ne(e);
    if (e.children) {
      oe(e.children, function(e) { p(e) })
    }
  }
  function Ie(t, e, r) {
    if (t.tagName === "BODY") {
  ...
  function ke(e, t, r) { return m(e, e.firstChild, t, r) }
  function Pe(e, t, r) { return m(u(e), e, t, r) }
  function Me(e, t, r) { return m(e, null, t, r) }
  function Xe(e, t, r) { return m(u(e), e.nextSibling, t, r) }
  function De(e, t, r) {
    p(e);
  ...
  function Be(e, t, r) {
    ...
    if (n) {
      ...
      oe(t.querySelectorAll(n), function(e) { i.appendChild(e) });
      t = i
    }
    return t
  }
  ...
  function Qe(e, t, r) {
    return $e.exec(e.charAt(0)) && e !== "true" && e !== "false" &&
           e !== "this" && e !== r && t !== "."
  }
  function et(e, t, r) {
    if (t[0] === "[") {
      ...
      while (t.length > 0) {
        ...
        if (o === "]") {
          ...
          if (n === 0) {
            ...
            i += ")})";
            try {
              var s = Tr(e, function() { return Function(i)() },
  ...
  function at(e) { ae(e).cancelled = true }
  function ot(e, t, r) {
    var n = ae(e);
        ...
        if (t.handledFor.indexOf(a) < 0) {
          ...
          if (s.throttle > 0) {
            if (!u.throttle) {
              o(a, e);
              u.throttle =
                  setTimeout(function() { u.throttle = null }, s.throttle)
            }
          } else if (s.delay > 0) {
            u.delayed = setTimeout(function() { o(a, e) }, s.delay)
          } else {
            ce(a, "htmx:trigger");
            o(a, e)
          }
  ...
  function mt(t) {
    if (!o(t, "data-hx-revealed") && X(t)) {
      ...
      if (e.initHash) {
        ...
        t.addEventListener("htmx:afterProcessNode",
                           function(e) { ce(t, "revealed") }, {once : true})
      }
    }
  }
  function pt(e, t, r) {
  ...
  function xt(s, r, n) {
    ...
    t.onclose = function(e) {
      if ([ 1006, 1012, 1013 ].indexOf(e.code) >= 0) {
        var t = wt(n);
        setTimeout(function() { xt(s, r, n + 1) }, t)
      }
    };
    ...
    t.addEventListener("message", function(e) {
      ...
      var t = e.data;
      R(s, function(e) { t = e.transformResponse(t, null, s) });
      var r = T(s);
      var n = l(t);
      var i = M(n.children);
      for (var a = 0; a < i.length; a++) {
  ...
  function bt(u) {
    var f = c(u, function(e) { return ae(e).webSocket != null });
    if (f) {
  ...
  function Ct(a, o) {
    ...
    if (s) {
      ...
      var u = function(e) {
        ...
        var t = e.data;
        R(a, function(e) { t = e.transformResponse(t, null, a) });
        var r = wr(a);
        var n = ye(a);
        var i = T(a);
  ...
  function Ot(e) { return ae(e).sseEventSource != null }
  function qt(e, t, r, n) {
    var i = function() {
      if (!r.loaded) {
        r.loaded = true;
  ...
  function At(e) {
    if (Q.config.allowScriptTags && (e.type === "text/javascript" ||
                                     e.type === "module" || e.type === "")) {
      var t = re().createElement("script");
      oe(e.attributes, function(e) { t.setAttribute(e.name, e.value) });
  ...
  function Nt(e) {
    ...
    oe(f(e, "script"), function(e) { At(e) })
  }
  function It(e) {
    var t = e.attributes;
    for (var r = 0; r < t.length; r++) {
      var n = t[r].name;
      if (s(n, "hx-on:") || s(n, "data-hx-on:") || s(n, "hx-on-") ||
          s(n, "data-hx-on-")) {
        return true
      }
    }
  ...
  function Pt(e) {
    if (e.querySelectorAll) {
      ...
      var r = e.querySelectorAll(
          i + t + ", form, [type='submit'], [hx-sse], [data-hx-sse], [hx-ws]," +
    ...
    if (r.initHash !== Le(t)) {
      ...
      if (!n) {
        if (ne(t, "hx-boost") === "true") {
          ...
          e.forEach(function(e) { Lt(t, e, r, function() {}) })
        }
      }
  ...
  function Gt(e) { return e === "htmx:afterProcessNode" }
  function R(e, t) {
    oe(Fr(e), function(e) {
      try {
        t(e)
  ...
  function ce(e, t, r) {
    ...
    R(e,
      function(
          e) { i = i && (e.onEvent(t, n) !== false && !n.defaultPrevented) });
    return i
  }
    ...
    e.onload = function() {
      if (this.status >= 200 && this.status < 400) {
        ...
        ce(re().body, "htmx:historyRestore",
           {path : a, cacheMiss : true, serverResponse : this.response})
      } else {
  ...
  function ar(e) {
    ...
    if (t) {
      ...
      setTimeout(function() { window.scrollTo(0, t.scroll) }, 0);
      Jt = e;
  ...
  function fr(e) {
    ...
    if (e.type === "button" || e.type === "submit" || e.tagName === "image" ||
  ...
  function hr(t, r, n, e, i) {
    ...
    if (fr(e)) {
      ...
      if (e.multiple && e.tagName === "SELECT") {
        o = M(e.querySelectorAll("option:checked"))
    ...
    if (e.willValidate) {
      ...
      if (!e.checkValidity()) {
        ...
        ce(e, "htmx:validation:failed",
           {message : e.validationMessage, validity : e.validity})
      }
    }
  }
  function dr(e, t) {
    ...
    hr(r, n, a, e, s);
    if (o.lastButtonClicked || e.tagName === "BUTTON" ||
    ...
    oe(f, function(e) {
      hr(r, n, a, e, s);
      if (!h(e, "form")) {
        oe(e.querySelectorAll(rt), function(e) { hr(r, n, a, e, s) })
      }
    });
    n = le(n, i);
  ...
  function Rr(e, t, r, n) {
    ...
    if (i) {
      ...
      var s;
      if (o) {
        s = Tr(e, function() { return Function("return (" + a + ")")() }, {})
      } else {
        s = E(a)
      }
      for (var l in s) {
  ...
  function Or(e, t) { return Rr(e, "hx-vars", true, t) }
  function qr(e, t) { return Rr(e, "hx-vals", false, t) }
    ...
    if (r) {
      if (r instanceof Element || I(r, "String")) {
        return he(e, t, null, null,
                  {targetOverride : g(r), returnPromise : true})
      } else {
  ...
  function he(t, r, n, i, a, e) {
    ...
    if (e === undefined) {
      var D = function(e) { return he(t, r, n, i, a, !!e) };
      var U = {
        target : u,
        elt : n,
        path : r,
    ...
    if (f.xhr) {
      if (f.abortable) {
        ...
        if (p === "first" && f.queuedRequests.length === 0) {
          f.queuedRequests.push(function() { he(t, r, n, i, a) })
        } else if (p === "all") {
          f.queuedRequests.push(function() { he(t, r, n, i, a) })
        } else if (p === "last") {
          f.queuedRequests = [];
  ...
  function Mr(l, u) {
    ...
    var o = le(
        {shouldSwap : i, serverResponse : g, isError : a, ignoreTitle : m}, u);
    ...
    if (o.shouldSwap) {
      ...
      R(l, function(e) { g = e.transformResponse(g, f, l) });
      if (d.type) {
        er()
      }
      ...
      if (b && ce(l, "htmx:beforeTransition", u) &&
  ...
  function Dr() {
    return {
      init: function(e) { return null },
          onEvent: function(e, t) { return true },
          transformResponse: function(e, t, r) { return e },
          isInlineSwap: function(e) { return false },
          handleSwap: function(e, t, r, n) { return false },
          encodeParameters: function(e, t, r) { return null }
    }
  }
  function Ur(e, t) {
    if (t.init) {
  ...
  var Vr = false;
  re().addEventListener("DOMContentLoaded", function() { Vr = true });
  function jr(e) {
